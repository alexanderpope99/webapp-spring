                              ...
                              automat
										...
										<Col md={6}>
											<Form.Group id="zilecm">
												...
												<InputGroup>
													<Form.Control type="number" disabled min="0" value={this.state.zilecmlucratoare} />
										...
										<Col md={6}>
											<Form.Group id="zilecolucratoare">
												...
												<InputGroup>
													<Form.Control type="number" disabled min="0" value={this.state.zilecolucratoare} />
