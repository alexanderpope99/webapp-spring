...
public class ZileCODisponibileController {
    ...
    public List<ZileCODisponibile> getAllPersoane() {
        return zileCODisponibileRepository.findAll();
    }

    @GetMapping("{id}")
    public ResponseEntity<ZileCODisponibile> getZileCODisponibileById(@PathVariable(value="id") Long id) throws ResourceNotFoundException
    {
    ...
    @PutMapping("{id}")
    public ResponseEntity<ZileCODisponibile> updateZileCODisponibile(@PathVariable(value = "id") Long id,  @RequestBody ZileCODisponibile newZileCODisponibile) throws ResourceNotFoundException {
        ZileCODisponibile zileCODisponibile = zileCODisponibileRepository.findById(id)
        .orElseThrow(() -> new ResourceNotFoundException("ZileCODisponibile not found for this id :: " + id));
