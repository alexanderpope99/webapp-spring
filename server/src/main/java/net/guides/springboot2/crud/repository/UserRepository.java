...
public interface UserRepository extends JpaRepository<User, Integer> {
	...
	List<User> findBySocietati_idIsNull();
	...
	List<SocietateDTO> getSocietiesByUserId(int id);
	...
	List<PersoanaDTO> getPersoanaByUserId(int id);
	...
	List<SocietateDTO> getSocietateByUserId(int id);
	...
	List<PersoanaDTO> getSuperiorByUserId(int id);
