...
@Service
public class FacturaOldService {
	FacturaOldService() {
	}
	...
	public FacturaOld save(FacturaOldDTO facturaDTO) throws ResourceNotFoundException {
		FacturaOld factura = modelMapper.map(facturaDTO, FacturaOld.class);
	...
	public FacturaOld update(int facturaID, FacturaOldDTO newFacturaDTO) throws ResourceNotFoundException {
	...
	public FacturaOld updateKeepOldFile(int facturaID, FacturaOldDTO newFacturaDTO) throws ResourceNotFoundException {
		newFacturaDTO.setId(facturaID);
		FacturaOld oldFactura = facturaRepository.findById(facturaID)
				.orElseThrow(() -> new ResourceNotFoundException("Nu există factura cu id: " + facturaID));

		FacturaOld factura = modelMapper.map(newFacturaDTO, FacturaOld.class);
