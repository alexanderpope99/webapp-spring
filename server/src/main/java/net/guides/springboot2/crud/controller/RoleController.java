...
public class RoleController {
    ...
    @PutMapping("{id}")
    public ResponseEntity<Role> updateRole(@PathVariable("id") int id, @RequestBody Role newRole)
    ...
    @DeleteMapping("{id}")
    public Map<String, Boolean> deleteRole(@PathVariable("id") int id) throws ResourceNotFoundException {
        Role role = roleRepository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException("Role not found for this id :: " + id));
